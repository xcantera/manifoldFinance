...
uniform vec3 g_OutlineColor1; // {"default":"0 0 0","label":"ui_editor_properties_outline_color","material":"outlinecolor","type":"color"}
uniform vec3 g_OutlineColor2; // {"default":"1 1 1","label":"ui_editor_properties_outline_background","material":"backgroundcolor","type":"color"}
uniform float g_DetectionThreshold; // {"material":"threshold","label":"ui_editor_properties_detection_threshold","default":0.5,"range":[0,5]}
uniform float g_DetectionMultiply; // {"material":"multiply","label":"ui_editor_properties_detection_multiply","default":1,"range":[0,5]}
